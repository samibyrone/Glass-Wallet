...
export default function FundWalletPage() {
  ...
  const [cryptoMethod, setCryptoMethod] = useState<"onramp" | "external">(
    "onramp"
  );
  ...
  const handleDepositSui = async () => {
    ...
    try {
      const response = await fetch(
        "https://glass-wallet.onrender.com/api/wallets/deposit/sui",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        toast({
          ...
          description: data.message || "SUI deposit initiated successfully!"
        });
        setStep(step + 1);
      } else {
        toast({
          ...
          description:
            data.message || "Failed to deposit SUI. Please try again.",
          variant: "destructive"
        });
      }
    } catch (error) {
      console.error("Deposit SUI error:", error);
      toast({
        title: "Error",
        description:
          "An unexpected error occurred during SUI deposit. Please try again.",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
        ...
        <div className='max-w-2xl mx-auto'>
          ...
          <Card className='shadow-xl border-0'>
            <CardHeader className='text-center'>
              ...
              <CardDescription>
                Add money to your Glass Wallet to start transacting
              </CardDescription>
            </CardHeader>
                ...
                <div className='space-y-6'>
                  ...
                  {currencyType === "fiat" && (
                    <div className='space-y-4'>
                      ...
                      <RadioGroup
                        value={fiatMethod}
                        onValueChange={(value: "card" | "transfer") =>
                          setFiatMethod(value)
                        }
                      >
                            ...
                            >
                              ...
                              <div>
                                ...
                                <p className='text-sm text-muted-foreground'>
                                  Instant funding with your card
                                </p>
                              </div>
                            </Label>
                          </div>
                  ...
                  {currencyType === "crypto" && (
                    <div className='space-y-4'>
                      ...
                      <RadioGroup
                        value={cryptoMethod}
                        onValueChange={(value: "onramp" | "external") =>
                        ...
                        <div className='flex items-start space-x-2'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-blue-700 mt-1'>
                              Use the account details below to transfer funds.
                              Include your reference ID in the transfer
                              description.
                            </p>
                          </div>
                        </div>
                          ...
                          <div>
                            ...
                            <div className='flex items-center justify-between mt-1'>
                              ...
                              <Button
                                ...
                                size='sm'
                                onClick={() =>
                                  copyToClipboard(bankAccount.routingNumber)
                                }
                              >
                                {copied ? (
                                  <CheckCircle className='h-4 w-4' />
                        ...
                        <div className='flex items-start space-x-2'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-orange-700 mt-1'>
                              Only send SUI tokens to this address. Sending
                        ...
                        <div>
                          ...
                          <div className='flex items-center justify-between mt-1'>
                            ...
                            <Button
                              ...
                              size='sm'
                              onClick={() =>
                                copyToClipboard(cryptoWallet.address)
                              }
                            >
                              {copied ? (
                                <CheckCircle className='h-4 w-4' />
                        ...
                        <div>
                          ...
                          <div className='flex items-center justify-between mt-1'>
                            ...
                            <Button
                              variant='ghost'
                              size='sm'
                              onClick={() => copyToClipboard(cryptoWallet.memo)}
                            >
                              {copied ? (
                                <CheckCircle className='h-4 w-4' />
                              ) : (
                ...
                <div className='space-y-6'>
                  <div className='text-center'>
                    ...
                    <p className='text-slate-600'>
                      Your funding request has been processed. You will receive
                      a confirmation once the transaction is complete.
                    </p>
                  </div>
